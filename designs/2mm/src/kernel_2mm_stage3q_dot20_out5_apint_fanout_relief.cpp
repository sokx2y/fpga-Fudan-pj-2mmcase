...
// Stage 3Q: v3p with bit-accurate local accumulators and input fanout relief.
//
// Keep the proven v3p architecture:
//   DOT20 / OUT5
//   initless A/B/C
...
//   dot-product accumulator uses a conservative ap_int<24>
//   a/tmp input operands are copied per OUT lane to encourage local registers
//
// The visible tmp and D values are still cast back to DATA_TYPE, preserving the
// 16-bit truncation semantics used by the original short computation.
