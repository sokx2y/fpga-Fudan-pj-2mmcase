...
// Stable Stage 2.5 manual-validation snapshot: DOT=100, OUT=4, full D storage.
#define DOT_UNROLL_FACTOR 100
...
void kernel_2mm(short seed, int *sum)
{
  ...
  #pragma HLS ARRAY_PARTITION variable=tmp cyclic factor=100 dim=2
