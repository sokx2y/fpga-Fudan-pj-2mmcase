...
// Stage 3B cleanup: DOT=25, OUT=4, full tmp, no full D, lane sums.
// Compared with the current champion, this removes the dead tmp zero-fill loop.
...
#error "stage3b_dot25_out4_noD_lane_sum_skip_tmp_init requires no full D storage and on-the-fly sum."
#endif
