...
// Stage 3B-light micro-tune: DOT=50, OUT=2, full tmp, no full D storage.
// Compared with noD_onthefly_sum, split the final D reduction into lane sums.
...
#error "stage3b_dot50_out2_noD_lane_sum requires no full D storage and on-the-fly sum."
#endif
