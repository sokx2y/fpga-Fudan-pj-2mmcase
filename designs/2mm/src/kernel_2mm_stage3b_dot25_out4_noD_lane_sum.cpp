...
// Stage 3B OUT4 routing-relief probe: DOT=25, OUT=4, full tmp, no full D.
// This keeps OUT4 width but halves K-lane pressure versus DOT50 OUT4.
...
#error "stage3b_dot25_out4_noD_lane_sum requires no full D storage and on-the-fly sum."
#endif
